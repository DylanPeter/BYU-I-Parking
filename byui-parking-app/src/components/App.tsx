    ...
    <div className="app">
      <section className="hero">
        <div>
          ...
          <p>
            The dashboard is your starting point. Browse lots, reserve spots,
            and view purchases once signed in.
          </p>
        </div>
      </section>
            ...
            {currentUser ? (
              ...
              <div className="auth-required-card">
                <div className="detail-card payment-card">
                  ...
                  <p>
                    Sign in or create an account to access your past purchases
                    and payment details.
                  </p>
